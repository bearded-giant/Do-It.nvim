...
describe("main_window", function()
    before_each(function()
        ...
        -- Mock vim.api.nvim_win_is_valid and vim.api.nvim_buf_is_valid
        ...
        -- Mock vim.api.nvim_create_namespace
        ...
        -- Mock vim.api.nvim_buf_clear_namespace
    ...
    it("should format todo with due date correctly", function()
        ...
        package.loaded["dooing.calendar"] = {
            ...
            get_language = function() return "en" end
        }
    ...
    it("should toggle todo window", function()
        -- Track if render_todos was called
        ...
        -- First call should open the window
        main_window.toggle_todo_window()
        
        -- Verify render_todos was called

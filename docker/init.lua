...
-- Direct fix for the storage module
...
dooing_storage.setup = function(M, config)
  ...
  -- Completely replace save_to_disk with our own implementation
  M.save_to_disk = function()
    ...
    local ok, write_err = pcall(function() file:write(json_content) end)
    file:close()
